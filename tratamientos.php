...
<head>
    ...
    <style>
        ...
        /* ===== MANIFIESTO (pergamino) ===== */
        .trat-manifiesto-wrap {
            max-width: 780px;
            margin: 0 auto;
            background: #fdfaf6;
        ...
        .trat-manifiesto-wrap::before,
        .trat-manifiesto-wrap::after {
            content: '';
            position: absolute;
        ...
        .trat-manifiesto-wrap::before { top: 14px; }
        .trat-manifiesto-wrap::after  { bottom: 14px; }

        .trat-manifiesto-overline {
            font-size: 0.75rem;
            font-weight: 600;
            letter-spacing: 4px;
            text-transform: uppercase;
        ...
        .trat-manifiesto-title em {
            font-style: italic;
            color: #5a6b5c;
        }

        .trat-manifiesto-ornament {
            font-size: 1.4rem;
            color: #c8bfb1;
            margin: 1.2rem 0;
            line-height: 1;
        ...
        .trat-manifiesto-body p {
            margin-bottom: 1rem;
        }

        .trat-manifiesto-body p:last-child {
            margin-bottom: 0;
        }

        .trat-manifiesto-body em {
            font-style: italic;
            color: #434f44;
        }

        @media (max-width: 768px) {
            .trat-manifiesto-wrap { padding: 2.5rem 1.5rem; }
            .trat-manifiesto-body { font-size: .95rem; }
        }
    </style>
</head>
...
<body>
    ...
    <!-- ===== POR QUÉ ELEGIRNOS ===== -->
    <div class="container-fluid px-3 px-md-5 pb-4">
        <div class="trat-section">
            <div class="row g-5 align-items-start">
                <div class="col-12">
                    <p class="trat-overline">Nuestra diferencia</p>
                    <h2 class="trat-title">¿Por qué <em>elegirnos</em>?</h2>
                    <div class="trat-divider"></div>
                </div>
                <div class="col-lg-6">
                    <ul class="list-unstyled trat-body mb-0" style="display:grid; gap:.9rem;">
                        <li class="d-flex align-items-start gap-3">
                            <span style="min-width:28px; height:28px; border-radius:2px; background:#f5f3f0; border:1px solid #e8e4df; display:inline-flex; align-items:center; justify-content:center; color:#434f44; font-size:.8rem; margin-top:.15rem;">
                                <i class="fas fa-check"></i>
                            </span>
                            <span><strong>Enfoque integral:</strong> tratamos la piel desde adentro</span>
                        </li>
                        <li class="d-flex align-items-start gap-3">
                            <span style="min-width:28px; height:28px; border-radius:2px; background:#f5f3f0; border:1px solid #e8e4df; display:inline-flex; align-items:center; justify-content:center; color:#434f44; font-size:.8rem; margin-top:.15rem;">
                                <i class="fas fa-check"></i>
                            </span>
                            <span><strong>Protocolos 100% personalizados</strong></span>
                        </li>
                        <li class="d-flex align-items-start gap-3">
                            <span style="min-width:28px; height:28px; border-radius:2px; background:#f5f3f0; border:1px solid #e8e4df; display:inline-flex; align-items:center; justify-content:center; color:#434f44; font-size:.8rem; margin-top:.15rem;">
                                <i class="fas fa-check"></i>
                            </span>
                            <span><strong>Medicina estética + integrativa + biorreguladora + regenerativa</strong></span>
                        </li>
                        <li class="d-flex align-items-start gap-3">
                            <span style="min-width:28px; height:28px; border-radius:2px; background:#f5f3f0; border:1px solid #e8e4df; display:inline-flex; align-items:center; justify-content:center; color:#434f44; font-size:.8rem; margin-top:.15rem;">
                                <i class="fas fa-check"></i>
                            </span>
                            <span><strong>Abordaje de causas reales:</strong> inflamación, hormonas, metabolismo y estilo de vida</span>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <ul class="list-unstyled trat-body mb-0" style="display:grid; gap:.9rem;">
                        <li class="d-flex align-items-start gap-3">
                            ...
                            <span><strong>Resultados naturales,</strong> progresivos y duraderos</span>
                        </li>
                        <li class="d-flex align-items-start gap-3">
                            <span style="min-width:28px; height:28px; border-radius:2px; background:#f5f3f0; border:1px solid #e8e4df; display:inline-flex; align-items:center; justify-content:center; color:#434f44; font-size:.8rem; margin-top:.15rem;">
                                <i class="fas fa-check"></i>
                            </span>
                            <span><strong>Productos de alta calidad</strong> y con registro INVIMA</span>
                        </li>
                        <li class="d-flex align-items-start gap-3">
                            <span style="min-width:28px; height:28px; border-radius:2px; background:#f5f3f0; border:1px solid #e8e4df; display:inline-flex; align-items:center; justify-content:center; color:#434f44; font-size:.8rem; margin-top:.15rem;">
                                <i class="fas fa-check"></i>
                            </span>
                            <span><strong>Cuidado que respeta tu armonía</strong> y entiende tu cuerpo</span>
                        </li>
                        <li class="d-flex align-items-start gap-3">
                            <span style="min-width:28px; height:28px; border-radius:2px; background:#f5f3f0; border:1px solid #e8e4df; display:inline-flex; align-items:center; justify-content:center; color:#434f44; font-size:.8rem; margin-top:.15rem;">
                                <i class="fas fa-check"></i>
                            </span>
                            <span><strong>Acompañamiento médico</strong> cercano, humano y consciente</span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container-fluid px-3 px-md-5 pb-5">
        <div class="trat-manifiesto-wrap">
            <p class="trat-manifiesto-overline">Manifiesto</p>
            <h2 class="trat-manifiesto-title">Doctora <em>Eddi</em></h2>
            <div class="trat-manifiesto-ornament">❧</div>
            <div class="trat-manifiesto-body">
