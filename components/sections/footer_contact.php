<section id="contacto" class="footer-contact">
    <div class="container-fluid px-3 px-md-5">
        ...
        <div class="footer-header text-center mb-5">
            ...
            <p class="text-white-50" style="font-size: 1.2rem;">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
        </div>
                    ...
                    <div>
                        ...
                        <div class="contact-info-item d-flex align-items-start mb-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:contacto@doctoraeddi.com" class="text-decoration-none fw-semibold" style="font-size: 1.15rem; color: #434f44;">
                                    contacto@doctoraeddi.com
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="contact-info-item d-flex align-items-start mb-4">
                            ...
                            <div>
                                ...
                                <span class="fw-semibold" style="font-size: 1.15rem; color: #434f44;">
                                    La Estrella · Área Metropolitana
                                </span>
                            </div>
                        </div>
                    </div>
